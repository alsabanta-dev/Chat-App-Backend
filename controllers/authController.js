...
exports.signup = catchAsync(async (req, res, next) => {
  if(!req.body.passwordConfirm) return next(new AppError('passwordConfirm is required', 400))

  if(req.body.password != req.body.passwordConfirm) return next(new AppError('Passwords are not the same', 400))
